...
@app.route("/portfolio")
def portfolio():
    # Sample portfolio data - you can modify this with your actual projects
    projects = [
        {
            'title': 'Phishing Detection System',
            'description': 'Machine learning-based system for detecting phishing URLs using hybrid algorithms',
            'tech_stack': ['Python', 'Flask', 'Scikit-learn', 'Bootstrap'],
        ...
        },
        {
            ...
            'description': 'Real-time monitoring dashboard for web security threats and analytics',
            'tech_stack': ['Python', 'Flask', 'SQLite', 'JavaScript'],
            'image': 'static/download (1).png',
            'github': '#',
            'demo': '#'
        },
        {
            'title': 'Data Analysis Notebook',
            'description': 'Interactive Jupyter notebook for data analysis and visualization',
            'tech_stack': ['Python', 'Jupyter', 'Pandas', 'Matplotlib'],
            'image': 'static/download (2).png',
            'github': '#',
            'demo': '/notebook'
        }
    ]
    ...
    skills = {
        ...
        'Tools': ['Git', 'Jupyter', 'SQLite', 'VS Code']
    }
